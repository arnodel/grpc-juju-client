...
func request_ApplicationService_Deploy_0(ctx context.Context, marshaler runtime.Marshaler, client ApplicationServiceClient, req *http.Request, pathParams map[string]string) (ApplicationService_DeployClient, runtime.ServerMetadata, error) {
...
func RegisterApplicationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ApplicationServiceClient) error {
	...
	mux.Handle("POST", pattern_ApplicationService_Deploy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_ApplicationService_Deploy_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
